...
<div class="col1"><!--Start Bottom web content-->
   	 ...
   	 <div class="col2">
    	<div class="header">
    		<div id="header_title">Spot-Music TOP 6 SONGS &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="Frontend/SongRank.php" id="link" style="font:Verdana, Geneva, sans-serif; font-size:12px;">See Rankings</a></div>
...
<div class="footer_wrapper">
    <div class="footer_menu">
   		<ul>
        	<li>Find the us <a href="Frontend/Contacts.php">Spot-Music</a> or <a href="Frontend/Contacts.php">contact us</a>  for more information</li>  
        </ul>
        <br /> <br /> <br />
        <span style="color:#999; font-size:14px; margin-top:10px;">&copy;Spot-Music, Inc.</span>
    </div>
</div>
</body>
</html>
